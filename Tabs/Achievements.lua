...
WHC.Achievements = {
    ...
    TIDEHUNTER             = { id = 1000000000000000,    icon = "inv_misc_head_murloc_01",             itemId = "707019000000", itemLink = "", name = "Tidehunter",             desc = "Reach level 60 while only gaining monster experience from murlocs." },
